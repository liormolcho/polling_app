...
urlpatterns = [ url(r'^$', views.api_root),
				...
				url(r'^(?P<question_url>[0-9]+)/$', views.QuestionItem.as_view(), name='get_question'),
				url(r'^(?P<question_url>[0-9]+)/choices/$', views.QuestionChoices.as_view(), name='question_choices'),
